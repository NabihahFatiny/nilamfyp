...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-white w3-animate-left w3-card" style="z-index:3;width:320px;" id="mySidebar">
  ...
  <a href="report.php" class="w3-bar-item w3-button w3-blue"><i class="fa fa-print w3-margin-right"></i>REPORT</a>
	...
	<div class="w3-container w3-content w3-card w3-padding-16" style="max-width:1000px;">    
	  ...
	  <div class="w3-row w3-white w3-padding">
		...
		<table class="w3-table w3-table-all">
			...
			<?PHP
			$bil = 0;
			$SQL_list = "SELECT * FROM `report`,`student` WHERE report.id_student = student.id_student AND student.id_student = $id_student ";
