...
// jika arahan login Student (tekan LOGIN)
if($act == "login")
{	
	$SQL_login 	= " SELECT * FROM `student` WHERE `email` = '$email' AND `password` = '$password'  ";
...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-white w3-animate-left w3-card" style="z-index:3;width:320px;" id="mySidebar">
  ...
  <div id="Demo1" class="w3-hide w3-animate-left">
    <a href="index.php" class="w3-bar-item w3-button w3-border-bottom test w3-hover-light-grey w3-light-grey"  id="firstTab">
     ...
     <a href="login-teacher.php" class="w3-bar-item w3-button w3-border-bottom test w3-hover-light-grey" >
      <div class="w3-container">
