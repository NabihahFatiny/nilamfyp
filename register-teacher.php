...
if($act == "register")
{
	...
	$found 	= numRows($con, "SELECT * FROM `teacher` WHERE `email` = '$email' ");
...
{	
	...
	$SQL_insert = " 
	INSERT INTO `teacher`(`id_teacher`, `name`, `email`, `password`) 
  ...
  <div id="Demo1" class="w3-hide w3-animate-left">
    <a href="index.php" class="w3-bar-item w3-button w3-border-bottom test w3-hover-light-grey"  id="firstTab">
      <div class="w3-container">
        <span ><i class="fa fa-teacher w3-margin-right"></i>Student</span>
      </div>
    </a>
     <a href="login-pengurus.php" class="w3-bar-item w3-button w3-border-bottom test w3-hover-light-grey w3-light-grey" >
      <div class="w3-container">
        <span ><i class="fa fa-teacher-md w3-margin-right"></i>Teacher</span>
      </div>
    </a>
  </div>
</nav>
...
<div class="w3-panel w3-green w3-display-container w3-animate-zoom">
  ...
  <h3>Success!</h3>
  <p>Your registration was successful! You may now <a href="login-teacher.php" class="w3-xlarge">Login.</a> </p>
</div>
<?PHP  } ?>
...
<?PHP } ?>			
			<div class="w3-center">Already registered? <a href="login-teacher.php" class="w3-text-blue">Login here</a></div> 
