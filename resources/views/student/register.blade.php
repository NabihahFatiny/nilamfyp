...
<div class="w3-panel w3-green w3-display-container w3-animate-zoom">
  ...
  <h3>Success!</h3>
  <p>Your registration was successful! You may now <a href="{{ route('student.login') }}" class="w3-xlarge">Login.</a> </p>
</div>
@endif
...
@if(!session('success'))
			...
			<h3>Student Registration</h3>
			  ...
			  <div class="w3-section">
				...
				<input class="w3-input w3-border w3-round" type="date" name="dob" value="{{ old('dob') }}" required>
				@error('dob')
					<div class="w3-text-red">{{ $message }}</div>
				@enderror
			  </div>
			  ...
			  <div class="w3-section">
				...
				<select class="w3-select w3-border w3-round" name="class" required>
...
@endif
			<div class="w3-center">Already registered? <a href="{{ route('student.login') }}" class="w3-text-blue">Login here</a></div>
