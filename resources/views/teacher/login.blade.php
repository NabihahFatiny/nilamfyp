...
@endif
			...
			<div class="w3-center" style="margin-top: 20px;">
				<p>Don't have account yet? <a href="{{ route('teacher.register') }}" class="w3-text-blue" style="text-decoration: underline; cursor: pointer; font-weight: bold;">Sign up here</a></p>
			</div>
